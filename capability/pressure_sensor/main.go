...
func (i *Implementation) Init(supervisor zda.CapabilitySupervisor) {
	...
	i.attributeMonitor = i.supervisor.AttributeMonitorCreator().Create(i, zcl.PressureMeasurementId, pressure_measurement.MeasuredValue, zcl.TypeSignedInt16, i.attributeUpdate)
}
