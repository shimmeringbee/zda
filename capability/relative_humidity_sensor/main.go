...
func (i *Implementation) Init(supervisor zda.CapabilitySupervisor) {
	...
	i.attributeMonitor = i.supervisor.AttributeMonitorCreator().Create(i, zcl.RelativeHumidityMeasurementId, relative_humidity_measurement.MeasuredValue, zcl.TypeUnsignedInt16, i.attributeUpdate)
}
